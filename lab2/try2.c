...
struct area start = {NULL, NULL, 0} ;//qidinew

void *malloc2(size_t size){//qidinew
    
    void *page2;
    page2 = mmap(0, size+sizeof(area), PROT_READ|PROT_WRITE, MAP_PRIVATE|MAP_ANONYMOUS, -1, 0);
    printf("page2 %p\n", page2);

    struct area* nb = (struct area*) page;
